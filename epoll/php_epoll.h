...
#define PHP_EPOLL_VERSION "0.1.0" /* Replace with version number for your extension */
...
/* Always refer to the globals in your function as EPOLL_G(variable).
   You are encouraged to rename these macros something shorter, see
   examples in any other php module directory.
*/
#define EPOLL_G(v) ZEND_MODULE_GLOBALS_ACCESSOR(epoll, v)

#if defined(ZTS) && defined(COMPILE_DL_EPOLL)
