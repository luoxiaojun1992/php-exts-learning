...
PHP_FUNCTION(confirm_epoll_compiled)
{
	...
	strg = strpprintf(0, "Congratulations! You have successfully modified ext/%.78s/config.m4. Module %.78s is now compiled into PHP.", "epoll", arg);
...
{
#if defined(COMPILE_DL_EPOLL) && defined(ZTS)
